...
class KakaoRepository {
  ...
  getGoogleToken = async (code) => {
    const googleToken = await axios({
      ...
      data: qs.stringify({ grant_type: 'authorization_code', client_id: process.env.GOOGLE_CLIENT_ID, client_secret: process.env.GOOGLE_CLIENT_SECRET, redirect_uri: process.env.GOOGLE_CALLBACK_URL_LOCAL, code: code, }),
  ...
  getNaverToken = async (code, state) => {
    const naverToken = await axios({
      ...
      data: qs.stringify({ client_id: process.env.NAVER_CLIENT_ID, client_secret: process.env.NAVER_CLIENT_SECRET, redirectUri: process.env.NAVER_CALLBACK_URL_LOCAL, state: state, code: code, }),

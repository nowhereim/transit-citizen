  ...
  try {
    ...
    console.log(refreshResult);
        ...
        //   try {
            ...
            res.status(401).send({ errorMessage: "로그인 후 이용 가능한 기능입니다(3)." });
        ...
        //   }) };
          ...
          const newToken = jwt.sign({ snsId: decoded.snsId }, process.env.SECRET_KEY, { expiresIn: "20s", });
      ...
      } else {  // 3. 액세스가 만료된 게 아니라면 무조건 로그인 허용.
        console.log(decoded.snsId);
      ...
      res.status(401).send({
        errorMessage: "로그인 후 이용 가능한 기능입니다(4).",
      });
    }
